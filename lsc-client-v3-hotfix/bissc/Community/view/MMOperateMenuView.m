...
- (void)setUpUI
{
    ...
    [button setImage:[UIImage imageNamed:@"留言1"] forState:UIControlStateNormal];
...
- (void)menuClick
{
    if ([[UserInfo sharedUserInfo].momentType isEqualToString:@"1"]) {
...
- (void)likeClick
{
    [UIView animateWithDuration:0.2 animations:^{
        ...
        self.menuView.left = kOperateWidth-kOperateBtnWidth;
    }];
