...
- (void)badgeInit
{
    ...
    self.badgePadding   = 6;
    self.badgeMinSize   = 8;
    self.badgeOriginX   = self.frame.size.width - self.badge.frame.size.width/2 -4;
    self.badgeOriginY   = -6;
...
- (void)updateBadgeFrame
{
    ...
    self.badge.frame = CGRectMake(self.badgeOriginX + 2, self.badgeOriginY -5, minWidth + padding, minHeight + padding);
